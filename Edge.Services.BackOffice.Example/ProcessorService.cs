...
namespace Edge.Services.BackOffice.Example
{
	public class ProcessorService : PipelineService
	{
		protected override Core.Services.ServiceOutcome DoPipelineWork()
		{
			...
			StreamReader streamReader=new StreamReader(@"D:\test\ 1240 20111023@0615 (1014711) .xml",Encoding.UTF8);
			// ------------------------------------------
			// ------------------------------------------
			// ------------------------------------------
			
			var boReader = new XmlDynamicReader(streamReader.BaseStream,  "harmon.ie.metrics/tracker");
